        ...
        <div class="container-fluid d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    <h1 class="display-2 text-white">Kelurahan {{ $desa->nama_desa }}</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update-desa', $desa) }}" method="POST">
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="nama_desa">Nama Kelurahan</label>
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="nama_kepala_desa">Nama Kepala Kelurahan</label>
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="alamat_kepala_desa">Alamat Kepala Kelurahan</label>
