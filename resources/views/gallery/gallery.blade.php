...
@section('title', 'Website Resmi Kelurahan ' . $desa->nama_desa . ' - Gallery')

@section('styles')
    <meta name="description"
        content="Gallery Kelurahan {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}">
...
@section('header')
    ...
    <p class="text-white">Gallery Kelurahan {{ $desa->nama_desa }}, masyarakat dapat dengan mudah mengetahui informasi
        mengenai
        macam-macam gallery kelurahan {{ $desa->nama_desa }}.</p>
@endsection
