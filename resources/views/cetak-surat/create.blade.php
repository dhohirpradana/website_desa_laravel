...
@section('title', 'Kelurahan ' . $desa->nama_desa . ' - Buat ' . $surat->nama)

@section('styles')
    <meta name="description"
        content="Buat {{ $surat->nama }} di Website Kelurahan {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}">
@endsection
