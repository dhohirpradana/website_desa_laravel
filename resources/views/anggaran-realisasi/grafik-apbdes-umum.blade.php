...
@section('title', 'Website Resmi Pemerintah Kelurahan ' . App\Desa::find(1)->nama_desa . ' - Statistik Penduduk')

@section('styles')
    <meta name="description"
        content="Statistik Penduduk Kelurahan {{ App\Desa::find(1)->nama_desa }}, Kecamatan {{ App\Desa::find(1)->nama_kecamatan }}, Kabupaten {{ App\Desa::find(1)->nama_kabupaten }}.">
    <link href="{{ asset('/css/style.css') }}" rel="stylesheet">
@endsection

@section('header')
    <h1 class="text-white text-muted">GRAFIK APBD Kelurahan</h1>
    <p class="text-white">Grafik Anggaran Pendapatan Belanja Kelurahan {{ $desa->nama_desa }}, masyarakat dapat dengan
        mudah mengetahui informasi mengenai Grafik Anggaran Pendapatan Belanja Kelurahan {{ $desa->nama_desa }}.</p>
@endsection
