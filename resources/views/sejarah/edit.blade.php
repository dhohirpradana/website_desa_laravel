                ...
                <form autocomplete="off" action="{{ route('sejarah.update', $sejarah) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-center">
                            <img onclick="$(this).siblings('.images').click()" class="mw-100 upload-image" style="max-height: 300px" src="{{ $sejarah->gambar ? asset(Storage::url($sejarah->gambar)) : asset('storage/upload.jpg') }}" alt="">
