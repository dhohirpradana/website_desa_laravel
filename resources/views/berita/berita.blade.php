...
@section('title', 'Website Resmi Pemerintah Kelurahan ' . $desa->nama_desa . ' - Berita')

@section('styles')
    <meta name="description"
        content="Macam-macam berita Kelurahan {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}.">
...
@section('header')
    ...
    <p class="text-white">Berita Kelurahan {{ $desa->nama_desa }}, masyarakat dapat dengan mudah mengetahui informasi
        seputar
        berita kelurahan {{ $desa->nama_desa }}.</p>
@endsection
