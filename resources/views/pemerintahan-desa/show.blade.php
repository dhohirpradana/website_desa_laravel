...
@section('title', 'Kelurahan ' . $desa->nama_desa . ' - Kelurahan ' . $pemerintahan_desa->judul)

@section('styles')
    <meta name="description"
        content="{{ $pemerintahan_desa->judul }} Kelurahan {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}.">
