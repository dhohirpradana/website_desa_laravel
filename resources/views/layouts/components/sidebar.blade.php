<div class="container-fluid">
    ...
    <a class="text-center pt-0" href="{{ route('home.index') }}">
        <h1 class="text-primary font-weight-900 text-uppercase">Kelurahan {{ $desa->nama_desa }}</h1>
    </a>
    <!-- User -->
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="row">
                <div class="col-6 collapse-brand">
                    <a href="{{ route('home.index') }}">
                        <h1 class="text-primary"><b>Kelurahan {{ $desa->nama_desa }}</b></h1>
                    </a>
                </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='kelola-pemerintahan-desa' ||
                    Request::segment(1)=='tambah-pemerintahan-desa' || Request::segment(1)=='pemerintahan-desa' ) active @endif" href="{{ route('pemerintahan-desa.index') }}">
