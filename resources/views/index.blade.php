            ...
            <div class="header-body text-center mt-5 mb-3">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-6 border-bottom">
                        ...
                        <p class="text-white">Dengan menggunakan layanan online website {{ config('app.name') }}, masyarakat dapat dengan mudah mengajukan beberapa surat keterangan berikut ini secara online.</p>
                    </div>
                </div>
            </div>
        </div>
